...
class CBSSingleAgentState:
    ...
    def plan(self, i):
        return bfs.plan(CBSSingleAgentState(None,i,0,-1)) 

    def sic(self, i):
        return (len(bfs.plan(CBSSingleAgentState(None,i,0,-1)) ))
    ...
    def __init__(self, p, robot, g, action):
        ...
        self.g = g
        self.h = 0
        #self.manhattan_distance() # TODO: Your job - Set a better heuristic value # previously it was 0.
        self.action = action
    ...
    def expand(self):
        ...
        for action in Action:
            ...
            if child_robot.warehouse.are_open_cells(occupies[0], self.robot.carry): 
                ...
                successors.append(CBSSingleAgentState(self, child_robot, self.g + 1, action))
        return successors
